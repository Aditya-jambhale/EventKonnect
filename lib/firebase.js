...
import { getDatabase, ref, set, get ,push,onValue,off,update} from "firebase/database";
...
export { app, auth, database, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut, ref, set, get ,push,onValue,off,update};
