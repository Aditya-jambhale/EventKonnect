...
import { EventStats, CategoryChart, AttendeeChart, PriceChart, LikesChart } from '../../../components/dashboard/charts';
            ...
            <div className="max-w-7xl w-full">
                <div className="text-center space-y-4 mb-12">
                    ...
                    <p className="text-xl text-muted-foreground animate-in slide-in-from-bottom duration-1000">
                        Transform your event data into stunning insights 🎭 Discover trends, track success, and elevate your events! 🚀
                    </p>
                </div>
                ...
                {eventData && (
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 animate-in fade-in-50 duration-500">
                        ...
                        <PriceChart data={eventData} />
                        <LikesChart data={eventData} className="md:col-span-2 lg:col-span-3" />
                    </div>
                )}

                {!eventData && !error && (
                    <div className="text-center text-muted-foreground animate-pulse">
                        <p className="text-lg">🎪 Click the button above to discover amazing event insights! 🎪</p>
                    </div>
                )}
            </div>
        </div>
